...
export function resetGameState() {
    // Sauvegarder l'ID de partie actuel avant la réinitialisation
    ...
    gameState.gameId = currentGameId; // Conserver l'ID de partie existant
    ...
    console.log("État du jeu réinitialisé, ID de partie préservé:", currentGameId);
}
